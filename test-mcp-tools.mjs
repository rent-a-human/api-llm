...
async function runTests() {
    ...
    try {
        ...
        console.log("❌ get_directory_tree FAILED:", e?.message || e);
    }
    ...
    try {
        ...
        console.log("✅ Boundary enforcement SUCCESS (Intercepted by throw):", e?.message || e);
    }
    ...
    try {
        ...
        console.log("✅ /etc/passwd block SUCCESS (Intercepted by throw):", e?.message || e);
    }
